...
By applying the power consumption model, the power consumption reduction can be estimated, as shown by \eref{ana:eq:power}. The results are summarised in \fref{ana:summary}.
