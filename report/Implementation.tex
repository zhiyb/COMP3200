...
The GPIO on the camera module was controlling a LED on the module, and it was controllable through the driver. Therefore by controlling the GPIO, it not only can gives indications about camera activity, but also is very useful for debugging and triggering external power analyser.
