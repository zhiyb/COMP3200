...
#if IS_ENABLED(CONFIG_SOC_CAMERA_OV5647)
static int ardbeg_ov5647_power(struct device *dev, int enable)
{
	return 0;
}

struct ov5647_platform_data ardbeg_ov5647_data;

static struct i2c_board_info ardbeg_ov5647_camera_i2c_device = {
	I2C_BOARD_INFO("ov5647_v4l2", 0x36),
	.platform_data = &ardbeg_ov5647_data,
};

static struct tegra_camera_platform_data ardbeg_ov5647_camera_platform_data = {
	.flip_v			= 0,
	.flip_h			= 0,
	.port			= TEGRA_CAMERA_PORT_CSI_A,
	.lanes			= 2,
...
static struct soc_camera_link ov5647_iclink = {
	.bus_id		= 0, /* This must match the .id of tegra_vi01_device */
	.board_info	= &ardbeg_ov5647_camera_i2c_device,
	.module_name	= "ov5647_v4l2",
	.i2c_adapter_id	= 1,
	.power		= ardbeg_ov5647_power,
	.priv		= &ardbeg_ov5647_camera_platform_data,
};

static struct platform_device ardbeg_ov5647_soc_camera_device = {
	.name	= "soc-camera-pdrv",
	.id	= 0,
	.dev	= {
...
#if 0
static int ardbeg_ov5647_power_on(struct ov5647_power_rail *pw)
{
	int err;
...
static int ardbeg_ov5647_power_off(struct ov5647_power_rail *pw)
{
	if (unlikely(WARN_ON(!pw || !pw->iovdd || !pw->avdd))) {
		tegra_io_dpd_enable(&csia_io);
		return -EFAULT;
...
struct ov5647_platform_data ardbeg_ov5647_data = {
	//.power_on = ardbeg_ov5647_power_on,
	//.power_off = ardbeg_ov5647_power_off,
	.mclk_name = "mclk",
};
#endif
...
static struct camera_data_blob ardbeg_camera_lut[] = {
	...
	//{"ardbeg_ov5647_pdata", &ardbeg_ov5647_data},
...
#if IS_ENABLED(CONFIG_SOC_CAMERA_OV5647)
	platform_device_register(&ardbeg_ov5647_soc_camera_device);
#endif
	return 0;
}
